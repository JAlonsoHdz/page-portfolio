export default {
  ...
  header: {
    img:
      '/assets/dollar-gill-fcnbIO5axMI-unsplash-optimized.jpg',
    imgPlaceholder:
  ...
  stack: {
    ...
    tech: [
      {
        img: process.env.PUBLIC_URL + '/assets/java-logo.png',
        alt: 'mongodb',
      },
      {
      ...
      {
        img: process.env.PUBLIC_URL + '/assets/aws-logo.png',
        alt: 'node',
      },
      {
        img: process.env.PUBLIC_URL + '/assets/Ethereum-Logo.wine.png',
        alt: 'node',
      },
    ],
